...
c	Subroutine model_minus (npar,ncell_bas,ncl_riv,river)          ! ***
      Subroutine model_minus (i0,npar,ncell_bas,river)          ! ***
...
C   a) prescribed parameters and other values                        
      ...
      integer iyrfir,numyr,firday,TAYL,ncell,i0
...
c	Real SW_d,RDOWN_d,q45_d,U45_d
...
c  b) the rest variables         
      ...
      INTEGER ncl,land,year_print,jdy_pr  
...
c	integer npar,ncell_bas,ncl_riv(ncell_bas),ibas,icel_cal
      integer npar,ncell_bas,ibas,nmon,ixm,ia3,ia2,ia33,i0_cal
...
c  b) not needed at the next time step  
      real t_frost0,TZV,za2,y1,y2,ksiot0,tayot,d0
      real clay,sand
      real run_day(1700,12000)
	real pr_day(1700,12000),ec_day(1700,12000)
	integer n1(12000),n2(12000),n3(12000)
...
c open input files with parameters which are different for each grid cell
        open (7, file='d:\ISI-MIP2\fixed_fields\
     !fixed_param_cl_'//riv//'.txt')
...
c      lat_cell(icell)=lat
c	lon_cell(icell)=lon
...
c  479 format (3f6.3,4e14.4,f7.2,2f6.3,f8.2) 
  479 format (9e14.3,f6.3,F9.3,f10.5,2e14.4,5e12.4)    
...
c     ! snfr,ksi_up/100.,ksiot/100.,hsnow/100.,snalb,snles,wles,emkl*lsai
c     ! ,emkh*lsai,hsig0,t_frost,kodzim,w2,kksiot,ksiotpr      
...
c     !q45_d,swe_d,ksi_d,ksiot_d,snow_d
	...
	do ixm=1,12
      ...
      enddo
 9997 continue
c 		Write (55,587) year_print,ia2,ia33,
c     !	(surrun_transf+drain_transf)
  ...
  585 format(i5,2i4,8e14.3,2f10.3,e14.4,2f8.2,f5.2)
